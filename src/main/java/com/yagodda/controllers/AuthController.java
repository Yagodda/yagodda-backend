...
import com.yagodda.payload.response.CodeResponse;
...
public class AuthController {
    ...
    public ResponseEntity<Object> sendCode(@RequestParam("phoneNumber") String phoneNumber) {
        String code = userService.sendSmsCode(phoneNumber);
        return new ResponseEntity<>(new CodeResponse(code, true), HttpStatus.OK);
    }
}
